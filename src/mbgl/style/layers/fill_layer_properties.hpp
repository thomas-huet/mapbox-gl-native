...
struct FillOutlineColor
    : DataDrivenPaintProperty<Color, attributes::a_outline_color, uniforms::u_outline_color> {
    static Color defaultValue() {
        return {};
    }
};
...
class FillPaintProperties : public Properties<FillAntialias,
                                              FillOpacity,
                                              FillColor,
                                              FillOutlineColor,
                                              FillTranslate,
