...
struct SymbolPlacement : LayoutProperty<SymbolPlacementType> {
    ...
    static SymbolPlacementType defaultValue() {
...
struct IconRotationAlignment : LayoutProperty<AlignmentType> {
    ...
    static AlignmentType defaultValue() {
...
struct IconTextFit : LayoutProperty<IconTextFitType> {
    ...
    static IconTextFitType defaultValue() {
...
struct IconTextFitPadding : LayoutProperty<std::array<float, 4>> {
    ...
    static std::array<float, 4> defaultValue() {
        return { { 0, 0, 0, 0 } };
    }
};
...
struct IconAnchor : DataDrivenLayoutProperty<SymbolAnchorType> {
    ...
    static SymbolAnchorType defaultValue() {
...
struct TextJustify : DataDrivenLayoutProperty<TextJustifyType> {
    ...
    static TextJustifyType defaultValue() {
...
struct IconColor
    : DataDrivenPaintProperty<Color, attributes::a_fill_color, uniforms::u_fill_color> {
    static Color defaultValue() {
        return Color::black();
    }
};

struct IconHaloColor
    : DataDrivenPaintProperty<Color, attributes::a_halo_color, uniforms::u_halo_color> {
    static Color defaultValue() {
        return {};
    }
};

struct IconHaloWidth
    : DataDrivenPaintProperty<float, attributes::a_halo_width, uniforms::u_halo_width> {
    static float defaultValue() {
        return 0;
    }
};
...
struct IconHaloBlur
    : DataDrivenPaintProperty<float, attributes::a_halo_blur, uniforms::u_halo_blur> {
    static float defaultValue() {
        return 0;
    }
};
...
struct IconTranslateAnchor : PaintProperty<TranslateAnchorType> {
    static TranslateAnchorType defaultValue() {
...
class SymbolPaintProperties : public Properties<IconOpacity,
                                                IconColor,
                                                IconHaloColor,
                                                IconHaloWidth,
                                                IconHaloBlur,
