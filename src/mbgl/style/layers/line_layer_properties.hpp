...
struct LineCap : LayoutProperty<LineCapType> {
    ...
    static LineCapType defaultValue() {
...
struct LineJoin : DataDrivenLayoutProperty<LineJoinType> {
    ...
    static LineJoinType defaultValue() {
...
struct LineDasharray : CrossFadedPaintProperty<std::vector<float>> {
    static std::vector<float> defaultValue() {
        return {};
    }
};
...
class LineLayoutProperties : public Properties<LineCap, LineJoin, LineMiterLimit, LineRoundLimit> {
};

class LinePaintProperties : public Properties<LineOpacity,
                                              LineColor,
                                              LineTranslate,
                                              LineTranslateAnchor,
                                              LineWidth,
