...
MBGL_DEFINE_ENUM(VisibilityType,
                 {
                     { VisibilityType::Visible, "visible" }, { VisibilityType::None, "none" },
                 });
...
MBGL_DEFINE_ENUM(RotateAnchorType,
                 {
                     { RotateAnchorType::Map, "map" }, { RotateAnchorType::Viewport, "viewport" },
                 });
...
MBGL_DEFINE_ENUM(SymbolPlacementType,
                 {
                     { SymbolPlacementType::Point, "point" }, { SymbolPlacementType::Line, "line" },
                 });
...
MBGL_DEFINE_ENUM(LightAnchorType,
                 { { LightAnchorType::Map, "map" }, { LightAnchorType::Viewport, "viewport" } });
