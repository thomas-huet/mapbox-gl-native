...
FillPatternUniforms::Values FillPatternUniforms::values(mat4 matrix,
    ...
    return FillPatternUniforms::Values{
        uniforms::u_matrix::Value{ matrix }, uniforms::u_world::Value{ framebufferSize },
        uniforms::u_texsize::Value{ atlasSize }, uniforms::u_pattern_tl_a::Value{ a.tl() },
