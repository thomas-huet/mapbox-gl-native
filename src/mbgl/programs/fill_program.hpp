...
struct FillUniforms : gl::Uniforms<uniforms::u_matrix, uniforms::u_world> {};

struct FillPatternUniforms : gl::Uniforms<uniforms::u_matrix,
                                          uniforms::u_world,
                                          uniforms::u_texsize,
...
class FillProgram : public Program<shaders::fill,
                                   gl::Triangle,
...
class FillPatternProgram : public Program<shaders::fill_pattern,
                                          gl::Triangle,
                                          FillLayoutAttributes,
                                          FillPatternUniforms,
                                          style::FillPaintProperties> {
...
class FillOutlineProgram : public Program<shaders::fill_outline,
                                          gl::Line,
                                          FillLayoutAttributes,
                                          FillUniforms,
                                          style::FillPaintProperties> {
...
class FillOutlinePatternProgram : public Program<shaders::fill_outline_pattern,
                                                 gl::Line,
                                                 FillLayoutAttributes,
                                                 FillPatternUniforms,
                                                 style::FillPaintProperties> {
