...
struct BackgroundUniforms
    : gl::Uniforms<uniforms::u_matrix, uniforms::u_color, uniforms::u_opacity> {};

struct BackgroundPatternUniforms : gl::Uniforms<uniforms::u_matrix,
                                                uniforms::u_opacity,
                                                uniforms::u_texsize,
...
class BackgroundProgram : public Program<shaders::background,
                                         gl::Triangle,
...
class BackgroundPatternProgram : public Program<shaders::background_pattern,
                                                gl::Triangle,
                                                BackgroundLayoutAttributes,
