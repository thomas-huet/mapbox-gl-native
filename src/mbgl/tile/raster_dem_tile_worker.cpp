...
RasterDEMTileWorker::RasterDEMTileWorker(ActorRef<RasterDEMTileWorker>,
                                         ActorRef<RasterDEMTile> parent_)
    : parent(std::move(parent_)) {
}

void RasterDEMTileWorker::parse(std::shared_ptr<const std::string> data,
