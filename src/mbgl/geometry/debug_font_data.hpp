...
const int8_t simplex_3[] = { 11, 25, 4,  -7, -1, -1, 17, 25, 10, -7, -1,
...
const int8_t simplex_5[] = { 21, 21, 3,  0,  -1, -1, 8,  21, 10, 19, 10, 17, 9,  15, 7,  14,
                             5,  14, 3,  16, 3,  18, 4,  20, 6,  21, 8,  21, 10, 20, 13, 19,
                             16, 19, 19, 20, 21, 21, -1, -1, 17, 7,  15, 6,  14, 4,  14, 2,
                             16, 0,  18, 0,  20, 1,  21, 3,  21, 5,  19, 7,  17, 7 };
const int8_t simplex_6[] = { 23, 12, 23, 13, 22, 14, 21, 14, 20, 13, 19, 11, 17, 6,  15, 3,  13,
                             1,  11, 0,  7,  0,  5,  1,  4,  2,  3,  4,  3,  6,  4,  8,  5,  9,
                             12, 13, 13, 14, 14, 16, 14, 18, 13, 20, 11, 21, 9,  20, 8,  18, 8,
...
const int8_t simplex_22[] = { 16, 18, 15, 20, 12, 21, 10, 21, 7,  20, 5,  17, 4,  12, 4,  7,
...
const int8_t simplex_24[] = { 8,  21, 5,  20, 4,  18, 4,  16, 5,  14, 7,  13, 11, 12, 14,
                              11, 16, 9,  17, 7,  17, 4,  16, 2,  15, 1,  12, 0,  8,  0,
                              5,  1,  4,  2,  3,  4,  3,  7,  4,  9,  6,  11, 9,  12, 13,
                              13, 15, 14, 16, 16, 16, 18, 15, 20, 12, 21, 8,  21 };
const int8_t simplex_25[] = { 16, 14, 15, 11, 13, 9,  10, 8,  9,  8,  6,  9,  4,  11, 3,  14,
                              3,  15, 4,  18, 6,  20, 9,  21, 10, 21, 13, 20, 15, 18, 16, 14,
                              16, 9,  15, 4,  13, 1,  10, 0,  8,  0,  5,  1,  4,  3 };
const int8_t simplex_26[] = { 5,  14, 4, 13, 5, 12, 6, 13, 5, 14, -1,
                              -1, 5,  2, 4,  1, 5,  0, 6,  1, 5,  2 };
...
const int8_t simplex_31[] = { 3,  16, 3,  17, 4,  19, 5,  20, 7,  21, 11, 21, 13, 20,
                              14, 19, 15, 17, 15, 15, 14, 13, 13, 12, 9,  10, 9,  7,
                              -1, -1, 9,  2,  8,  1,  9,  0,  10, 1,  9,  2 };
const int8_t simplex_32[] = { 18, 13, 17, 15, 15, 16, 12, 16, 10, 15, 9,  14, 8,  11, 8,  8,
                              9,  6,  11, 5,  14, 5,  16, 6,  17, 8,  -1, -1, 12, 16, 10, 14,
                              9,  11, 9,  8,  10, 6,  11, 5,  -1, -1, 18, 16, 17, 8,  17, 6,
                              19, 5,  21, 5,  23, 7,  24, 10, 24, 12, 23, 15, 22, 17, 20, 19,
                              18, 20, 15, 21, 12, 21, 9,  20, 7,  19, 5,  17, 4,  15, 3,  12,
                              3,  9,  4,  6,  5,  4,  7,  2,  9,  1,  12, 0,  15, 0,  18, 1,
                              20, 2,  21, 3,  -1, -1, 19, 16, 18, 8,  18, 6,  19, 5 };
const int8_t simplex_33[] = { 9, 21, 1, 0, -1, -1, 9, 21, 17, 0, -1, -1, 4, 7, 14, 7 };
const int8_t simplex_34[] = { 4,  21, 4,  0,  -1, -1, 4,  21, 13, 21, 16, 20, 17, 19, 18, 17,
                              18, 15, 17, 13, 16, 12, 13, 11, -1, -1, 4,  11, 13, 11, 16, 10,
                              17, 9,  18, 7,  18, 4,  17, 2,  16, 1,  13, 0,  4,  0 };
const int8_t simplex_35[] = {
    18, 16, 17, 18, 15, 20, 13, 21, 9, 21, 7,  20, 5,  18, 4,  16, 3,  13,
...
const int8_t simplex_37[] = { 4,  21, 4,  0,  -1, -1, 4,  21, 17, 21, -1,
                              -1, 4,  11, 12, 11, -1, -1, 4,  0,  17, 0 };
const int8_t simplex_38[] = { 4, 21, 4, 0, -1, -1, 4, 21, 17, 21, -1, -1, 4, 11, 12, 11 };
const int8_t simplex_39[] = { 18, 16, 17, 18, 15, 20, 13, 21, 9,  21, 7,  20, 5,  18, 4,
                              16, 3,  13, 3,  8,  4,  5,  5,  3,  7,  1,  9,  0,  13, 0,
...
const int8_t simplex_45[] = { 4,  21, 4,  0,  -1, -1, 4,  21, 12, 0,  -1,
                              -1, 20, 21, 12, 0,  -1, -1, 20, 21, 20, 0 };
const int8_t simplex_46[] = { 4, 21, 4, 0, -1, -1, 4, 21, 18, 0, -1, -1, 18, 21, 18, 0 };
const int8_t simplex_47[] = { 9,  21, 7,  20, 5,  18, 4,  16, 3,  13, 3,  8,  4,  5,
...
const int8_t simplex_51[] = { 17, 18, 15, 20, 12, 21, 8,  21, 5,  20, 3,  18, 3,  16,
                              4,  14, 5,  13, 7,  12, 13, 10, 15, 9,  16, 8,  17, 6,
...
const int8_t simplex_55[] = { 2,  21, 7,  0,  -1, -1, 12, 21, 7,  0,  -1,
                              -1, 12, 21, 17, 0,  -1, -1, 22, 21, 17, 0 };
...
const int8_t simplex_59[] = { 4,  25, 4,  -7, -1, -1, 5,  25, 5,  -7, -1,
                              -1, 4,  25, 11, 25, -1, -1, 4,  -7, 11, -7 };
const int8_t simplex_60[] = { 0, 21, 14, -3 };
const int8_t simplex_61[] = { 9,  25, 9,  -7, -1, -1, 10, 25, 10, -7, -1,
                              -1, 3,  25, 10, 25, -1, -1, 3,  -7, 10, -7 };
const int8_t simplex_62[] = { 6, 15, 8,  18, 10, 15, -1, -1, 3, 12,
...
const int8_t simplex_71[] = { 15, 14, 15, -2, 14, -5, 13, -6, 11, -7, 8,  -7, 6,  -6, -1,
                              -1, 15, 11, 13, 13, 11, 14, 8,  14, 6,  13, 4,  11, 3,  8,
                              3,  6,  4,  3,  6,  1,  8,  0,  11, 0,  13, 1,  15, 3 };
const int8_t simplex_72[] = { 4, 21, 4,  0,  -1, -1, 4,  10, 7,  13,
                              9, 14, 12, 14, 14, 13, 15, 10, 15, 0 };
const int8_t simplex_73[] = { 3, 21, 4, 20, 5, 21, 4, 22, 3, 21, -1, -1, 4, 14, 4, 0 };
const int8_t simplex_74[] = { 5,  21, 6,  20, 7,  21, 6,  22, 5,  21, -1,
                              -1, 6,  14, 6,  -3, 5,  -6, 3,  -7, 1,  -7 };
const int8_t simplex_75[] = { 4, 21, 4, 0, -1, -1, 14, 14, 4, 4, -1, -1, 8, 8, 15, 0 };
const int8_t simplex_76[] = { 4, 21, 4, 0 };
const int8_t simplex_77[] = { 4,  14, 4,  0,  -1, -1, 4,  10, 7,  13, 9,  14,
                              12, 14, 14, 13, 15, 10, 15, 0,  -1, -1, 15, 10,
                              18, 13, 20, 14, 23, 14, 25, 13, 26, 10, 26, 0 };
const int8_t simplex_78[] = { 4, 14, 4,  0,  -1, -1, 4,  10, 7,  13,
                              9, 14, 12, 14, 14, 13, 15, 10, 15, 0 };
...
const int8_t simplex_87[] = { 3,  14, 7,  0,  -1, -1, 11, 14, 7,  0,  -1,
                              -1, 11, 14, 15, 0,  -1, -1, 19, 14, 15, 0 };
...
const int8_t simplex_91[] = { 9, 25, 7, 24, 6,  23, 5, 21, 5,  19, 6, 17, 7, 16, 8, 14,
                              8, 12, 6, 10, -1, -1, 7, 24, 6,  22, 6, 20, 7, 18, 8, 17,
                              9, 15, 9, 13, 8,  11, 4, 9,  8,  7,  9, 5,  9, 3,  8, 1,
                              7, 0,  6, -2, 6,  -4, 7, -6, -1, -1, 6, 8,  8, 6,  8, 4,
                              7, 2,  6, 1,  5,  -1, 5, -3, 6,  -5, 7, -6, 9, -7 };
const int8_t simplex_92[] = { 4, 25, 4, -7 };
const int8_t simplex_93[] = { 5, 25, 7, 24, 8,  23, 9,  21, 9,  19, 8, 17, 7, 16, 6, 14,
                              6, 12, 8, 10, -1, -1, 7,  24, 8,  22, 8, 20, 7, 18, 6, 17,
                              5, 15, 5, 13, 6,  11, 10, 9,  6,  7,  5, 5,  5, 3,  6, 1,
                              7, 0,  8, -2, 8,  -4, 7,  -6, -1, -1, 8, 8,  6, 6,  6, 4,
                              7, 2,  8, 1,  9,  -1, 9,  -3, 8,  -5, 7, -6, 5, -7 };
const int8_t simplex_94[] = { 3,  6,  3,  8, 4,  11, 6,  12, 8,  12, 10, 11, 14, 8,  16, 7,
